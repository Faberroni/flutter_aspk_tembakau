...
class AppColors {
  static const Color? brown = Color.fromARGB(220, 223, 180, 151);
  static const Color? green = Color.fromARGB(255, 34, 199, 169);
}

MaterialColor myGreen = MaterialColor(0xFF22c7a9, color);
MaterialColor myAccent = MaterialColor(0xFFc72240, color);
MaterialColor myBrown = MaterialColor(0xFFDFB497, color);
